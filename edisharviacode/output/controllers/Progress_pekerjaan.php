...
class Progress_pekerjaan extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Progress_pekerjaan_model');
    ...
    public function index()
    {
        ...
        $data = array(
			...
			'controller' => 'Progress_pekerjaan',
			'uri1' => 'List Progress_pekerjaan',
			'main_view' => 'progress_pekerjaan/progress_pekerjaan_list'
        );
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			...
			'main_view' => 'progress_pekerjaan/progress_pekerjaan_read',
            ...
            redirect(site_url('progress_pekerjaan'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('progress_pekerjaan/create_action'),
			'controller' => 'Progress_pekerjaan',
			'uri1' => 'Tambah Progress_pekerjaan',
			'main_view' => 'progress_pekerjaan/progress_pekerjaan_form',
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('progress_pekerjaan/update_action'),
				'controller' => 'Progress_pekerjaan',
