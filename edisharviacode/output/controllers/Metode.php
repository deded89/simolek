...
class Metode extends CI_Controller
{
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('metode/create_action'),
			'controller' => 'Metode',
			'uri1' => 'Tambah Metode',
			'main_view' => 'metode/metode_form',
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('metode/update_action'),
				'controller' => 'Metode',
				'uri1' => 'Update Metode',
				'main_view' => 'metode/metode_form',
