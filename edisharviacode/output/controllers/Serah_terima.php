...
class Serah_terima extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
			...
			'controller' => 'Serah_terima',
			'uri1' => 'List Serah_terima',
			'main_view' => 'serah_terima/serah_terima_list'
        );
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			...
			'main_view' => 'serah_terima/serah_terima_read',
            ...
            redirect(site_url('serah_terima'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('serah_terima/create_action'),
			'controller' => 'Serah_terima',
			'uri1' => 'Tambah Serah_terima',
			'main_view' => 'serah_terima/serah_terima_form',
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('serah_terima/update_action'),
				'controller' => 'Serah_terima',
