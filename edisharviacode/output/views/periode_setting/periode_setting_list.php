				   ...
				   <thead>
					...
					?>
						<tr>
							...
							<td><?php echo $periode_setting->skpd ?></td>
							<td><?php echo $periode_setting->b01 ?></td>
							<td><?php echo $periode_setting->b02 ?></td>
							<td><?php echo $periode_setting->b03 ?></td>
							<td><?php echo $periode_setting->b04 ?></td>
							<td><?php echo $periode_setting->b05 ?></td>
							<td><?php echo $periode_setting->b06 ?></td>
							<td><?php echo $periode_setting->b07 ?></td>
							<td><?php echo $periode_setting->b08 ?></td>
							<td><?php echo $periode_setting->b09 ?></td>
							<td><?php echo $periode_setting->b10 ?></td>
							<td><?php echo $periode_setting->b11 ?></td>
							<td><?php echo $periode_setting->b12 ?></td>
