			...
			<form action="<?php echo $action; ?>" method="post">
				<table class='table table-bordered'>		
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="lama" id="lama" placeholder="Lama" value="<?php echo $lama; ?>" /></td>    
					</tr>
            
					<tr>
						<td><label for="date">Awal <?php echo form_error('awal') ?></label></td>
						<td><input type="text" class="form-control" name="awal" id="awal" placeholder="Awal" value="<?php echo $awal; ?>" /></td>    
					</tr>
            
					<tr>
						<td><label for="date">Akhir <?php echo form_error('akhir') ?></label></td>
						<td><input type="text" class="form-control" name="akhir" id="akhir" placeholder="Akhir" value="<?php echo $akhir; ?>" /></td>    
					</tr>
					...
					<tr>
						<td colspan='2'>
							...
							<a href="<?php echo site_url('Kontrak') ?>" class="btn btn-danger">Cancel</a>
						</td>	
					</tr>
				</table>
			</form>
