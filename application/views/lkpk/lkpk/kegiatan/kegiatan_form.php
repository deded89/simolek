	...
	<div class='col-xs-12'>
        ...
        <div class='box-body'>
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-9'>
              <input  type='text' class='form-control' name='sumber_dana' id='sumber_dana' placeholder='Isikan Sumber Dana' value='<?php echo $sumber_dana; ?>'>
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-9'>
              <input  type='text' class='form-control' name='tahun_anggaran' id='tahun_anggaran' placeholder='Isikan Tahun Anggaran' value='<?php echo $tahun_anggaran; ?>'>
          ...
          <div class='form-group'>
            <label for="tinyint" class='col-sm-2 control-label'>Pagu</label>
            <div class='col-sm-9'>
              <input  type='text' class='form-control' name='pagu' id='pagu' placeholder='Isikan Pagu' value='<?php echo $pagu; ?>'>
							<?php echo form_error('pagu') ?>
            </div>
          </div>

					<input type='hidden' name='id_kegiatan' value='<?php echo $pagu ?>'>
	        <!-- CSRF TOKEN -->
	        <?php
	          $csrf = array(
