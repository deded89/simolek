	...
	<div class='col-xs-12'>
		<div class='box box-info'>
			<div class='box-header with-border bg-aqua'>
				...
				<a href='<?php echo site_url('Periode_pagu') ?>'>
        ...
        <div class='box-body'>
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-9'>
              <input  type='text' class='form-control' name='nilai' id='nilai' placeholder='Isikan Nilai' value='<?php echo $nilai; ?>'>
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-9'>
              <input  type='text' class='form-control' name='kegiatan' id='kegiatan' placeholder='Isikan Kegiatan' value='<?php echo $kegiatan; ?>'>
					...
					<input type='hidden' name='id_per_pagu' value='<?php echo $kegiatan ?>'>
	        <!-- CSRF TOKEN -->
	        <?php
	          $csrf = array(
