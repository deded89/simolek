	...
	<div class='col-xs-12'>
		<div class='box box-info'>
			<div class='box-header with-border bg-aqua'>
				<h3 class='box-title'>Download Format Rencana Kegiatan</h3>
        ...
        <div class='box-body'>
            ...
            <h4><i class="icon fa fa-info"></i> Info :</h4>
						Untuk menambahkan rencana kegiatan silakan :
            <ol>
							<li>Pilih Tahun Anggaran, Periode dan Jenis Rencana yang ingin diinput (keuangan / fisik) kemudian klik Tombol Download Format</li>
							<li>Download format import data dalam bentuk Ms.Excel dengan klik Tombol Download Format</li>
							<li>Isi sesuai dengan format yang telah di download, nilai rencana yang diisi adalah nilai "PER BULAN" bukan "KUMULATIF"</li>
          ...
          <div class='form-group'>
	        ...
	        <input type='hidden' name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
					<div class='col-xs-12 text-center'>
						...
						<a href="<?php echo site_url('lkpk/kegiatan/hal_import_rencana') ?>"><input type='button' name='hal_import' id="hal_import" value='Import' class='btn btn-info'></a>
					</div>
				</div>
    	</form>
		</div>
