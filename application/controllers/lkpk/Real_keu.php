...
class Real_keu extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Real_keu_model');
    ...
    public function index()
    {
        ...
        $data = array(
			...
			'controller' => 'Real_keu',
			'uri1' => 'List Real_keu',
			'main_view' => 'real_keu/real_keu_list'
        );
    ...
    public function read($id) 
    {
        ...
        if ($row) {
			...
			'controller' => 'Real_keu',
			'uri1' => 'Data Real_keu',
			'main_view' => 'real_keu/real_keu_read',
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('real_keu/create_action'),
			'controller' => 'Real_keu',
			'uri1' => 'Tambah Real_keu',
			'main_view' => 'real_keu/real_keu_form',
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('real_keu/update_action'),
				'controller' => 'Real_keu',
