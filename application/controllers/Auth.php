...
class Auth extends CI_Controller {
	...
	// create a new user
	public function create_user($id_jab)
    {
        ...
        {
			//VALIDASI JIKA IDENTITY MENGGUNAKAN EMAIL
            $this->form_validation->set_rules('email', $this->lang->line('create_user_validation_email_label'), 'required|valid_email|is_unique[' . $tables['users'] . '.email]');
        }
		//VALIDASI INPUTAN LAINNYA
        $this->form_validation->set_rules('phone', $this->lang->line('create_user_validation_phone_label'), 'trim');
        $this->form_validation->set_rules('company', $this->lang->line('create_user_validation_company_label'), 'trim|required|is_unique[users.company]',array('is_unique' => 'User ini sudah memiliki username'));
